...
<section class="dashboard">
    <?php if(isset($_SESSION['add-user-success'])) : // shows if add user was successfully?>
        ...
        <?php elseif(isset($_SESSION['edit-user'])) : // shows if edit user was NOT successfull?>
        ...
        <?php elseif(isset($_SESSION['delete-user'])) : // shows if delete user was NOT successfull?>
        <div class="alert__message error container">
            <p>
        ...
        <?php elseif(isset($_SESSION['delete-user-success'])) : // shows if delete user was successfull?>
        <div class="alert__message success container">
            <p>
